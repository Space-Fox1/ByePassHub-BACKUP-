# ByePassHub > Exploits > Helpful Info | Updated 4/9
...
### Exploit Collections
**These are other exploit collections that are actively updated, and BETTER than mine. Use a proxy (mainUnblockers.md) if the sites are blocked.** <br>
Titanium Network: https://docs.titaniumnetwork.org/guides/ (they also have a really informative discord server, https://discord.gg/unblock)<br>
