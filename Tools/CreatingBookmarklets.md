# ByePassHub > Exploits > Creating a Bookmarklet | updated Jun 27
...
### Creating these allows you to run code found in the Bookmarklets.md, or [here](https://github.com/wea-f/ByePassHub/blob/main/Tools/Bookmarklets.md)
...
4. Enter the URL, either one of the scripts in [this](https://github.com/wea-f/ByePassHub/blob/main/Tools/Bookmarklets.md), the bookmarklet file
